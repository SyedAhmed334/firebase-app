...
class DataProvider extends ChangeNotifier{
  ...
  DocumentSnapshot<Object> get userData => _userData as DocumentSnapshot<Object>;
  Future<void> fetchData () async{
    _userData = await FirebaseFirestore.instance.collection('User Data').doc(auth.currentUser!.uid.toString()).get();
    notifyListeners();
  }
